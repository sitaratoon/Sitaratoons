    ...
    if id == owner_id:
        ...
        if "verify_" in message.text:
            ...
            if verify_status["link"] == "":
                reply_markup = None
            await message.reply(f"<b>✅ ʏᴏᴜʀ ᴛᴏᴋᴇɴ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴠᴇʀɪꜰɪᴇᴅ ᴀɴᴅ ᴠᴀʟɪᴅ ꜰᴏʀ: 12 ʜᴏᴜʀ⏳\n\n**<blockquote>ᴛᴜᴍʜᴀʀᴀ ᴛᴏᴋᴇɴ ᴠᴇʀɪꜰʏ ʜᴏɢᴀʏᴀ ʜᴀɪ ᴀʙ ᴠᴀᴘɪꜱ ᴄʜᴀɴɴᴇʟ ᴍᴇ ᴊᴀᴋᴇ ʟɪɴᴋ ᴍᴇ ᴄʟɪᴄᴋ ᴋᴀʀᴏ ✅></blockquote>**</b>", reply_markup=reply_markup, protect_content=False, quote=True)
